  ...
  <div>
    ...
    <div class="row">
      <div class="col-lg-4 ml-auto" style="margin-top: 15px;">
        <card :title="$t('your_info')" class="h-fixed-310">
          <h4 class="card-title">
        ...
        <div class="card" style="margin-top: 15px; margin-bottom: 35px;">
          <div class="card-header">
            <div style="float: left">{{ $t('your_projects') }}</div>
          </div>
          <div class="card-body">
            <div class="card" v-for="project in profile.projects" :key="project.id" style="margin-bottom: 10px;">
              <div class="card-body">
                <div class="card-title">
                  ...
                  <span style="float: right; margin-right: 5px; cursor: pointer" class="badge badge-dark"><fa icon="pencil-alt" fixed-width/></span>
      ...
      <div class="col-lg-8 ms-auto" style="margin-top: 15px; margin-bottom: 35px;">
        <div class="card">
          <div class="card-header">
            <div style="float: left">{{ $t('your_repos') }} (Order by Pushed)</div>
          </div>
          <div class="card-body">
            <div class="card" v-if="repository.owner" v-for="repository in profile.oauth_provider.github_repositories"
                 :key="repository.id"
              ...
              <div class="card-body">
                <div class="card-title">
                  ...
                  <span style="float: right; margin-right: 5px; cursor: pointer" class="badge badge-dark"
                        v-if="repository.is_visibility === 'public' && repository.has_project === false"
